...
document.querySelector("#clear-facts").onclick = function(){
    const facts = document.getElementsByClassName("generated-content");
	while(facts.length > 0){
        facts[0].parentNode.removeChild(facts[0]);
    }
}